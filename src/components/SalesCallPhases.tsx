...
const phases: Phase[] = [
  {
    id: "ingest",
    title: "Ingest",
    description: "Captures call notes and transcripts from sales conversations",
    icon: "🎙️",
  },
  {
    id: "extract",
    title: "Extract",
    description: "Identifies buyer intent, competitive signals, and technical constraints",
    icon: "🔍",
  },
  {
    id: "structure",
...
export function SalesCallPhases() {
  return (
