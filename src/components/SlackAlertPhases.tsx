...
const phases: Phase[] = [
  {
    id: "pull",
    title: "Pull",
    description: "Fetches daily revenue data from Sheets and BigQuery",
    icon: "📊",
  },
  {
    id: "compute",
    title: "Compute",
    description: "Calculates day-over-day and week-over-week deltas by vertical",
    icon: "⚙️",
  },
  {
    id: "flag",
    title: "Flag",
    description: "Identifies movers, missing data, and deal state changes",
    icon: "🔍",
  },
  {
    id: "explain",
  ...
  },
  {
    id: "alert",
    title: "Alert",
    description: "Posts structured updates to the right Slack channels",
    icon: "💬",
  },
];

export function SlackAlertPhases() {
  return (
